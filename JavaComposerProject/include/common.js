...
function storeUnhandledEvent() {
	_data.system.ipd.uncaughtApplicationEvents[_data.system.ipd.uncaughtApplicationEvents.length] = _event;
}

function isEventHandledByApplication() {
	return (_data.system.ipd.uncaughtApplicationEvents.indexOf(_event) == -1);
}
